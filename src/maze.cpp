...
vector<MazeArc> Maze::Solve(SearchStrategy strategy){
    return Solve(start_node_, strategy);
}

vector<MazeArc> Maze::Solve(MazeNode* start_node, SearchStrategy strategy){
